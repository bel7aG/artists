...
const Favorit = ({ stylish }) => {
  return (
    <SFavoritSVG
      ...
      x="0px"
      y="0px"
      viewBox="0 0 490.727 490.727"
      style={{ enableBackground: 'new 0 0 490.727 490.727' }}
    >
      <g>
        <path
          d="M453.443,160.214l-119.7-8.6c-2.5-0.2-4.7-1.7-5.6-4.1l-45.6-111c-6.3-15.3-20.5-24.8-37.1-24.8s-30.7,9.5-37.1,24.9
